...
import 'package:gamelobby/helper/signalr_match.dart';
...
class GamelobbyController extends GetxController
  ...
  late SignalRMatchService signalRMatchService;

  signalR() async {
    //Signal R //
    api = APIService.instance;
    signalRService = SignalRService(token: api.getToken()!);
    signalRMatchService = SignalRMatchService(token: api.getToken()!);

    await signalRService.startConnection();
    await signalRMatchService.startConnection();
    //Signal R //
  }
  ...
  signalRSTOP() async {
    ...
    await signalRMatchService.stopConnection();
    //Signal R //
  }
