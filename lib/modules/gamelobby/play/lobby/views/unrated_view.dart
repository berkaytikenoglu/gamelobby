          ...
          children: [
            ...
            CardWidget.playercard(
              ...
              player: Player(
                userid: 0,
                lobbyowner: true,
                username: Jwt.decodeJWTfetchname(api.getToken()!),
                avatar: "assets/images/banners/1.png",
        ...
        Row(
          ...
          children: [
            Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  unratedcontroller.matchsearchingDialog();
                },
                child: Text("OYNA"),
              ),
            ),
            Obx(
              () => controller.gameplayers.value == null
                  ? SizedBox.shrink()
                  : controller.gameplayers.value!.isEmpty
                      ? SizedBox.shrink()
                      : Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: ElevatedButton(
